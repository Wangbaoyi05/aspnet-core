...
{
    public abstract class ABPUnity01WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABPUnity01WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABPUnity01WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ABPUnity01DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ABPUnity01DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABPUnity01DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABPUnity01DbContext, Task<T>> func)
        {
            T result;
